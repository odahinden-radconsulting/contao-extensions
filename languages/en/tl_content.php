...
$GLOBALS['TL_LANG']['tl_content']['columns'][9] = '9 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][8] = '8 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][7] = '7 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][6] = '6 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][5] = '5 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][4] = '4 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][3] = '3 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][2] = '2 Columns';
$GLOBALS['TL_LANG']['tl_content']['columns'][1] = '1 Column';
$GLOBALS['TL_LANG']['tl_content']['columns'][0] = 'No Bootstrap Column';

$GLOBALS['TL_LANG']['tl_content']['offset'][11] = '11 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][10] = '10 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][9] = '9 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][8] = '8 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][7] = '7 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][6] = '6 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][5] = '5 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][4] = '4 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][3] = '3 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][2] = '2 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][1] = '1 Column Offset';
$GLOBALS['TL_LANG']['tl_content']['offset'][0] = 'No Offset';
